...
import './Footer.css';
import zoro from './images/monday-logo-x2.png'
import wm from './images/Footer_wm_logo.png'
import wn from './images/dev_new_mobile_footer_logo.avif'
import an from './images/crm_icon_footer.avif'
function Footer() {
    return (
        <div>
            <div className="beforef">
                <div className="contenter">
                    ...
                    <button className="bt1get">Get Started
                        <svg className="animated-text" width="10" height="14" viewBox="0 0 9 7" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M4.628.616a.5.5 0 1 0-.64.768L6.203 3.23H.5a.5.5 0 0 0 0 1h5.612L3.988 6a.5.5 0 1 0 .64.769l3.23-2.693a.5.5 0 0 0 0-.768L4.628.616z"></path>
                        </svg>
                    </button>
                </div>
            </div>
            <div className="footer">
                <div className="logosec">
                    <img id="mondayl" src={zoro} alt="Monday.com Logo" />
                    <p>Pricing</p>
                    <p>Contact us</p>
                    <p>Templates</p>
                    <p>SMB</p>
                ...
                <div className="mondaypro">
                    <p>monday products</p>
                    <p><img className="flogo" src={wm} alt="Monday Work Management" /> monday work management</p>
                    <p><img className="flogo" src={wn} alt="Monday Sales CRM" /> monday sales CRM</p>
                    <p><img className="flogo" src={an} alt="Dev New Mobile Footer Logo" /> dev new mobile footer logo</p>
                    <p>monday dev</p>
                    <p>More by monday.com</p>
                    <p>workcanvas icon footer</p>
                    <p>WorkCanvas</p>
                    <p>workforms</p>
                </div>
            ...
            <hr />
            <div class="multiplelogosectionbykrati">
                <p>
                ...
                <div class="icons-wrapper">
                    <div class="single-social-icon-wrapper">
                        <div class="social-media-icon"><a target="_blank" href="https://www.reddit.com/r/mondaydotcom"
                            title="Reddit" class="jsx-3692625068">
                            <div class="jsx-3692625068 regular-icon-container"><svg width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="jsx-3692625068">
                                <path
                    ...
                    <div class="jsx-4139997252 single-social-icon-wrapper">
                        <div class="jsx-3692625068 social-media-icon"><a target="_blank"
                            href="https://www.linkedin.com/company/2525169" title="LinkedIn" class="jsx-3692625068">
                            <div class="jsx-3692625068 regular-icon-container"><svg width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="jsx-3692625068">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="jsx-4139997252 single-social-icon-wrapper">
                        <div class="jsx-3692625068 social-media-icon"><a target="_blank"
                            href="https://www.facebook.com/mondaydotcom" title="Facebook" class="jsx-3692625068">
                            <div class="jsx-3692625068 regular-icon-container"><svg width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="jsx-3692625068">
                                <path
                    ...
                    <div class="jsx-4139997252 single-social-icon-wrapper">
                        <div class="jsx-3692625068 social-media-icon"><a target="_blank"
                            href="https://twitter.com/mondaydotcom" title="twitter" class="jsx-3692625068">
                            <div class="jsx-3692625068 regular-icon-container"><svg width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="jsx-3692625068">
                                <path
                    ...
                    <div class="jsx-4139997252 single-social-icon-wrapper">
                        <div class="jsx-3692625068 social-media-icon"><a target="_blank"
                            href="https://www.instagram.com/mondaydotcom" title="Instagram" class="jsx-3692625068">
                            <div class="jsx-3692625068 regular-icon-container"><svg width="25" height="24"
                                ...
                                <g clip-path="url(#clip0_1251_527)">
                                    <g clip-path="url(#clip1_1251_527)" fill="#535768">
                                        ...
                                        <path
                                            d="M11.75 5.475a5.78 5.78 0 1 0 .002 11.56 5.78 5.78 0 0 0-.002-11.56zm0 9.526a3.751 3.751 0 1 1 0-7.502 3.751 3.751 0 0 1 0 7.502zM17.757 6.592a1.349 1.349 0 1 0 0-2.697 1.349 1.349 0 0 0 0 2.697z">
                                        </path>
                                    </g>
                                </g>
                            </svg></div>
                    ...
                    <div class="jsx-4139997252 single-social-icon-wrapper">
                        <div class="jsx-3692625068 social-media-icon"><a target="_blank"
                            href="https://www.tiktok.com/@mondaydotcom" title="TikTok" class="jsx-3692625068">
                            <div class="jsx-3692625068 regular-icon-container"><svg width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="jsx-3692625068">
                                <path
                ...
                <div>
                    <svg width="135" height="40" viewBox="0 0 135 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="#fff"></path>
                        <path d="M10.4 7.5c-.3.3-.5.8-.5 1.4V31c0 .6.2 1.1.5 1.4l.1.1 12.4-12.4v-.2L10.4 7.5z"
                        ...
                        <path opacity=".25"
                            ...
                            fill="#fff"></path>
                        <defs>
                            <linearGradient id="paint0_linear" x1="21.8" y1="8.71" x2="5.017" y2="25.492"
                            ...
                            <linearGradient id="paint1_linear" x1="33.834" y1="20.001" x2="9.637" y2="20.001"
                                gradientUnits="userSpaceOnUse">
                            ...
                            <linearGradient id="paint2_linear" x1="24.827" y1="22.296" x2="2.069" y2="45.054"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#FF3A44"></stop>
                                <stop offset="1" stop-color="#C31162"></stop>
                            </linearGradient>
                            <linearGradient id="paint3_linear" x1="7.297" y1=".176" x2="17.46" y2="10.339"
                                gradientUnits="userSpaceOnUse">
