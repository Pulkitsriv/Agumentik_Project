...
const Header = () => {
  return (
    ...
    <div className="mainBodyContainer">
        ...
        <h1 className="tanjiro">
            La dématérialisation
            <br />
            au service de votre business
        </h1>
        <div className="dscpTC">
            Esalink vous accompagne dans la digitalisation de vos flux B2B
        </div>
        <div className="tWBC">
            <div className="bs">Trouver votre solution EDI</div>
            <div className="bs">Passer à la facturation électronique</div>
        </div>
